...
<%
    request.setAttribute("pageTitle", "Access Denied - CRS");
%>
...
<div class="crs-main">
    <div class="crs-card" style="max-width: 760px;">
        <h1 class="crs-page-title mb-3">Access Denied</h1>
        <p class="crs-page-subtitle mb-4">
            You do not have permission to access this page or action in the system.
        </p>
